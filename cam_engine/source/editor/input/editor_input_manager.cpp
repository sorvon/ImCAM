...
#include "editor/cam_editor/cam_editor.h"
...
namespace ImCAM
{
    ...
    void EditorInputManager::updateCursorOnAxis(glm::vec2 cursor_uv)
    {
    ...
    void EditorInputManager::onCursorPos(double xpos, double ypos)
    {
        ...
        //         {
        //             glm::vec2 cursor_uv = glm::vec2((m_mouse_x - m_engine_window_pos.x) / m_engine_window_size.x,
