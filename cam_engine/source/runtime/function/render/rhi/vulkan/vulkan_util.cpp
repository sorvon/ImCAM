...
namespace ImCAM
{
    ...
    void VulkanUtil::createCubeMap(VulkanRHI*                 rhi,
                                   VkImage&             image,
                                   VkImageView&         image_view,
                                   VmaAllocation&       image_allocation,
                                   uint32_t             texture_image_width,
    ...
    void VulkanUtil::genMipmappedImage(VulkanRHI* rhi, VkImage image, uint32_t width, uint32_t height, uint32_t mip_levels)
    {
        assert(rhi);
