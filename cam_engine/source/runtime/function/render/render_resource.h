...
namespace ImCAM
{
    ...
    struct IBLResourceData
    {
        ...
        PIXEL_FORMAT   _brdfLUT_texture_image_format;
        ...
        PIXEL_FORMAT   _irradiance_texture_image_format;
        ...
        PIXEL_FORMAT   _specular_texture_image_format;
    };
    ...
    struct ColorGradingResourceData
    {
        ...
        PIXEL_FORMAT _color_grading_LUT_texture_image_format;
    };
    ...
    {
    public:
        virtual void uploadGlobalRenderResource(std::shared_ptr<VulkanRHI> rhi,
                                                LevelResourceDesc    level_resource_desc) override final;

        virtual void uploadGameObjectRenderResource(std::shared_ptr<VulkanRHI> rhi,
    ...
    private:
        ...
        void createIBLTextures(std::shared_ptr<VulkanRHI>                        rhi,
                               std::array<std::shared_ptr<TextureData>, 6> irradiance_maps,
                               std::array<std::shared_ptr<TextureData>, 6> specular_maps);

        VulkanMesh& getOrCreateVulkanMesh(std::shared_ptr<VulkanRHI> rhi, RenderEntity entity, RenderMeshData mesh_data);
        VulkanPBRMaterial&
        getOrCreateVulkanMaterial(std::shared_ptr<VulkanRHI> rhi, RenderEntity entity, RenderMaterialData material_data);
