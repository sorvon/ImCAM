...
namespace ImCAM
{
    ...
    void RenderResource::uploadGameObjectRenderResource(std::shared_ptr<VulkanRHI> rhi,
                                              ...
                                              std::shared_ptr<RenderCamera> camera)
    {
        ...
        // ambient light
        glm::vec3  ambient_light   = render_scene->m_ambient_light.m_irradiance;
        ...
        {
            glm::vec3 point_light_position = render_scene->m_point_light_list.m_lights[i].m_position;
            ...
            m_mesh_point_light_shadow_perframe_storage_buffer_object.point_lights_position_and_radius[i] =
                glm::vec4(point_light_position, radius);
        }

        // directional light
        m_mesh_perframe_storage_buffer_object.scene_directional_light.direction =
            glm::normalize(render_scene->m_directional_light.m_direction);
    ...
    VulkanMesh&
    RenderResource::getOrCreateVulkanMesh(std::shared_ptr<VulkanRHI> rhi, RenderEntity entity, RenderMeshData mesh_data)
    {
    ...
    VulkanPBRMaterial& RenderResource::getOrCreateVulkanMaterial(std::shared_ptr<VulkanRHI> rhi,
                                                                 RenderEntity         entity,
                                                                 RenderMaterialData   material_data)
    {
        ...
        else
        {
            ...
            PIXEL_FORMAT base_color_image_format = PIXEL_FORMAT::PIXEL_FORMAT_R8G8B8A8_SRGB;
            ...
            PIXEL_FORMAT metallic_roughness_format       = PIXEL_FORMAT::PIXEL_FORMAT_R8G8B8A8_UNORM;
            ...
            PIXEL_FORMAT normal_roughness_format       = PIXEL_FORMAT::PIXEL_FORMAT_R8G8B8A8_UNORM;
            ...
            PIXEL_FORMAT occlusion_image_format = PIXEL_FORMAT::PIXEL_FORMAT_R8G8B8A8_UNORM;
            ...
            PIXEL_FORMAT emissive_image_format = PIXEL_FORMAT::PIXEL_FORMAT_R8G8B8A8_UNORM;
    ...
    void RenderResource::updateMeshData(std::shared_ptr<VulkanRHI>                   rhi,
    ...
    void RenderResource::updateVertexBuffer(std::shared_ptr<VulkanRHI>                   rhi,
                                            bool                                   enable_vertex_blending,
                                            uint32_t                               vertex_buffer_size,
                                            MeshVertexDataDefinition const*        vertex_buffer_data,
                                            uint32_t                               joint_binding_buffer_size,
    ...
    void RenderResource::updateIndexBuffer(std::shared_ptr<VulkanRHI> rhi,
                                           uint32_t             index_buffer_size,
                                           void*                index_buffer_data,
                                           VulkanMesh&          now_mesh)
    {
    ...
    void RenderResource::updateTextureImageData(std::shared_ptr<VulkanRHI> rhi, const TextureDataToUpdate& texture_data)
    {
        VulkanUtil::createGlobalImage(rhi.get(),
